...
const DatabaseService = {
    ...
    async addMessage(messageData) {
        try {
            ...
            console.log('Message added successfully:', messageData.name);
            return docRef.id;
        } catch (error) {
            throw handleFirebaseError(error, 'addMessage');
        }
    },
    ...
    async getMessages() {
        try {
            ...
            throw handleFirebaseError(error, 'getMessages');
        }
    },
    ...
    async deleteMessage(messageId) {
        try {
            ...
            throw handleFirebaseError(error, 'deleteMessage');
        }
    },
    ...
    async markMessageAsRead(messageId) {
        try {
            ...
            throw handleFirebaseError(error, 'markMessageAsRead');
        }
    }
};
